...
<!--To disable registration,  change the activeRegistration variable value to False-->
<?php
    $activeRegistration = "True";
    if ($activeRegistration == "True") {
        ...
        echo "Registration is disabled! Please ask admins to enable."
    }
?>
